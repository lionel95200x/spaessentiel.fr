...
export interface Product {
  ...
  gallery?:
    ...
    | null;
  layout?: (CallToActionBlock | ContentBlock | MediaBlock | ProductSeoBlock)[] | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProductSeoBlock".
 */
export interface ProductSeoBlock {
  title: string;
  content?: {
    root: {
      type: string;
...
export interface Post {
  ...
  title: string;
  /**
   * Résumé affiché sur la page listing du blog.
   */
  excerpt?: string | null;
  featuredImage?: (number | null) | Media;
  publishedOn?: string | null;
  /**
   * Compose le contenu de l'article avec des blocs.
   */
  layout: (CallToActionBlock | ContentBlock | MediaBlock | SplitBlock | BannerBlock | FaqBlock)[];
  meta?: {
    title?: string | null;
    /**
     * Maximum upload file size: 12MB. Recommended file size for images is <500KB.
...
export interface ProductsSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        content?: T | ContentBlockSelect<T>;
        mediaBlock?: T | MediaBlockSelect<T>;
        productSeoBlock?: T | ProductSeoBlockSelect<T>;
      };
  inventory?: T;
  enableVariants?: T;
  variantTypes?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProductSeoBlock_select".
 */
export interface ProductSeoBlockSelect<T extends boolean = true> {
  title?: T;
  content?: T;
  media?: T;
  imagePosition?: T;
