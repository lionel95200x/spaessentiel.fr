...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_reassurance_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_reassurance_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  	"version_supplier_url" varchar,
  	"version_supplier_price" numeric,
  	"version_supplier_id" integer,
  	"version_weight_kg" numeric,
  	"version_persons_capacity" numeric,
  ...
  ALTER TABLE "pages_blocks_reassurance_block" ADD CONSTRAINT "pages_blocks_reassurance_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_split_block" ADD CONSTRAINT "pages_blocks_split_block_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_category_showcase" ADD CONSTRAINT "_pages_v_blocks_category_showcase_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_reassurance_block" ADD CONSTRAINT "_pages_v_blocks_reassurance_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_split_block" ADD CONSTRAINT "_pages_v_blocks_split_block_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "suppliers_rels" ADD CONSTRAINT "suppliers_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_reassurance_block_order_idx" ON "pages_blocks_reassurance_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_reassurance_block_parent_id_idx" ON "pages_blocks_reassurance_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_reassurance_block_path_idx" ON "pages_blocks_reassurance_block" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_split_block_media_idx" ON "pages_blocks_split_block" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_reassurance_block_order_idx" ON "_pages_v_blocks_reassurance_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_reassurance_block_parent_id_idx" ON "_pages_v_blocks_reassurance_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_reassurance_block_path_idx" ON "_pages_v_blocks_reassurance_block" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_split_block_media_idx" ON "_pages_v_blocks_split_block" USING btree ("media_id");
  ...
  CREATE INDEX "suppliers_rels_order_idx" ON "suppliers_rels" USING btree ("order");
  CREATE INDEX "suppliers_rels_parent_idx" ON "suppliers_rels" USING btree ("parent_id");
  CREATE INDEX "suppliers_rels_path_idx" ON "suppliers_rels" USING btree ("path");
  CREATE INDEX "suppliers_rels_categories_id_idx" ON "suppliers_rels" USING btree ("categories_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_reassurance_block" CASCADE;
  ...
  DROP TABLE "pages_blocks_split_block" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_reassurance_block" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_split_block" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_split_block_image_position";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_split_block_image_position";
